...
vector<int> findMinMax(const vector<int>& vect, int low, int high) {
    if (low == high) {
        ...
        // just something to visualize the progress of the recursive func
        cout <<"Min of 1 and 2: " <<  minMaxVectOne[0] << ' ' << minMaxVectOne[1] << endl;
        cout <<"Max of 1 and 2: " <<  minMaxVectTwo[0] << ' ' << minMaxVectTwo[1] << endl << endl;
